function F = lsq_myfunfinal1(x0,lb,ub)
 
%lsq_myfunfinal1([15 -1.4 4.4e-19 6e-9 1e5 40e-9 0.3],[0 -Inf 0 0 0 0 0],[Inf 2 Inf 1e-10 1e6 Inf Inf])
%15 -1.4 4.4e-19 6e-9 1e5 40e-9 0.3
...
options=optimset('TolFun',1e-18 ,'TolX',1e-18,'MaxFunEvals',50000000,'MaxIter',100000000000000000,'DiffMinChange',1e-23,'Display','on','Diagnostics','on');
[x,resnorm,residual,exitflag,output] = lsqcurvefit(@myfun_lsq_mfunfinal1,x0,q,flucta,lb,ub,options)
x
for q=v1:v
