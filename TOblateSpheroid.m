function [Dt_a,Dt_b,Dr_a,Dr_b] = TOblateSpheroid(T,e,a,b)
% Function to calculate theoretical values of translational and 
% rotational diffusion for Oblate Spheroid using Einstein relation.
% --------------------- Input ---------------------------
% T: Temperature (K)
% e: viscosity (Pa.S)
% a: Length of major axis of an ellipse which Oblate Spheroid made of it. (m)
% b: Length of minor axis of an ellipse which Oblate Spheroid made of it (m)
% -------------------- Output ---------------------------
...
S = (2*atan(sqrt(b^2-a^2)/a))/sqrt(b^2-a^2);
