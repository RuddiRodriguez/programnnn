function [slope,mempos,interceptpoint]=membranepositionvw(intensities,linfitparameter)

%determines membraneposition in the v-w-coordinate system
...
% p(1)=p(1)/1.414213562; %corrects the slope because it was calculated here with a spacing of 1 in the x-achsis 

mempos=((meanvalue-p(2))/p(1))*1.414213562;
slope=p(1);
interceptpoint=p(2);