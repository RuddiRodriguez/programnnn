...
mkdir('C:/membrane_tracking_project/program/simulacion');
...
%u=(((1.3806e-23.*296.65)./((sigma.*(wavenr.^2))+(kappa1.*((wavenr.^4))))))+(((6.*rmean).*1.3806e-23.*296.65)./(12.*K.*(d).*((wavenr.^2))))
 u10=((1.3806e-23.*296.65)/(2.*sigma))*((1./wavenr)-(1./(((sigma./kappa)+(wavenr.^2)).^(0.5))))%+(((1.3806e-23.*296.659).*d)./(2.*kappa.*wavenr.^2))
 u10=((1.3806e-23.*296.65)/(2.*sigma))*((1./wavenr)-(1./(((sigma./kappa)+(wavenr.^2)).^(0.5)))+((6.*sigma.*(rmean))./(epsilon.*(h).*wavenr)))
%u10=((1.3806e-23.*296.65)./(2.*sigma)).*((1./wavenr)-(1./((sigma./kappa)+(wavenr.^2)).^0.5))
...
save('C:/membrane_tracking_project/program/simulacion/fluct.txt','u10','-ascii');
save('C:/membrane_tracking_project/program/simulacion/fluct1.txt','u1','-ascii');
save('C:/membrane_tracking_project/program/simulacion/fluct2.txt','u2','-ascii');
save('C:/membrane_tracking_project/program/simulacion/wave.txt','wavenr','-ascii');
figure(8)
%semilogy(wavenr,u)
% hold on;
semilogy(wavenr,fluct,'.',wavenr,fluct1,'-o',wavenr,u10,'-+',wavenr,u2,'-*',wavenr,u7,'-k',wavenr,sigma2u,'-.')
