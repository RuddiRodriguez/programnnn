...
% Last Modified by GUIDE v2.5 07-Mar-2016 13:17:15
...
% --- Executes on button press in Flot.
function Flot_Callback(hObject, eventdata, handles)
% hObject    handle to Flot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
floterror;
