...
function =resumen_dynamics_eritrocitos(m,kappa,sigmaexcess,ce)
...
figure(501)
subplot(2,2,1)
plot(wave,(1-amplitudmedia),'r-',wave,amplitudmedia,'k-')
hold on
errorbar(wave,(1-amplitudmedia),(errorampli),'r-')
errorbar(wave,(amplitudmedia),(errorampli),'k-')

hold on
subplot(2,2,2)
plot(wave,betamedia,'-o','MarkerEdgeColor','k', 'MarkerFaceColor','w')
hold on
errorbar(wave,betamedia,(errorbetamedia),'-o','MarkerEdgeColor','k', 'MarkerFaceColor','w')

subplot(2,2,3)
loglog(l,freben,'o',l,ms,'-k','MarkerEdgeColor','k', 'MarkerFaceColor','w')
hold on
...
subplot(2,2,4)
loglog(wave,freactividad,'-o','MarkerEdgeColor','r', 'MarkerFaceColor','w')
hold on
errorbar(wave,freactividad,errorfreactividad,'-o','MarkerEdgeColor','k', 'MarkerFaceColor','w')