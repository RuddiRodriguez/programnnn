...
mkdir(sprintf('%s/results/shape/',working_directory_path));
q=0
% variables:
...
for j = savedcontours
    cmean = cmean + transpose(a(:,j));
end
cmean = cmean/length(savedcontours);

for j = savedcontours
    cmeansquare = cmeansquare + transpose(a(:,j).^2);
end
...
save(sprintf('%s/results/shape/fluctuations.txt',working_directory_path),'fluctuation','-ascii')

save(sprintf('%s/results/shape/wavenumbers.txt',working_directory_path),'wavenumbers','-ascii')

save(sprintf('%s/results/shape/a.txt',working_directory_path),'a','-ascii')

save(sprintf('%s/results/shape/b.txt',working_directory_path),'b','-ascii')

save(sprintf('%s/results/shape/c.txt',working_directory_path),'c','-ascii')

save(sprintf('%s/results/shape/r0.txt',working_directory_path),'r0','-ascii')
