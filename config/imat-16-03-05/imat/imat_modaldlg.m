function varargout = imat_modaldlg(varargin)
...
%   applied to the GUI before imat_modaldlg_OpeningFunction gets called.  An
%   unrecognized property name or invalid value makes property application
%   stop.  All inputs are passed to imat_modaldlg_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',          mfilename, ...
                   ...
                   'gui_OpeningFcn',    @imat_modaldlg_OpeningFcn, ...
                   'gui_OutputFcn',     @imat_modaldlg_OutputFcn, ...
                   'gui_LayoutFcn',     [], ...
                   'gui_Callback',      []);
...
% --- Executes just before imat_modaldlg is made visible.
function imat_modaldlg_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to imat_modaldlg (see VARARGIN)

% Choose default command line output for imat_modaldlg
handles.output = 'Yes';
...
% UIWAIT makes imat_modaldlg wait for user response (see UIRESUME)
uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = imat_modaldlg_OutputFcn(hObject, eventdata, handles)
