function varargout = imat_dev(varargin)
...
%   applied to the GUI before imat_dev_OpeningFunction gets called.  An
%   unrecognized property name or invalid value makes property application
%   stop.  All inputs are passed to imat_dev_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',          mfilename, ...
                   ...
                   'gui_OpeningFcn',    @imat_dev_OpeningFcn, ...
                   'gui_OutputFcn',     @imat_dev_OutputFcn, ...
                   'gui_LayoutFcn',     [], ...
                   'gui_Callback',      []);
...
% --- Executes just before imat_dev is made visible.
function imat_dev_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to imat_dev (see VARARGIN)

% Choose default command line output for imat_dev
handles.output = 'Yes';
...
% UIWAIT makes imat_dev wait for user response (see UIRESUME)
uiwait(handles.figure1);

% --- Outputs from this function are returned to the command line.
function varargout = imat_dev_OutputFcn(hObject, eventdata, handles)
