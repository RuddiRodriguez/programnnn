...
r0 = load(sprintf('%s/results/r0_trunc.txt',working_directory_path));
%savedcontours=[4 5 6];
r0=r0(savedcontours);

flucta = load(sprintf('%s/results/fluctuationsa_trunc.txt',working_directory_path));
fluct = load(sprintf('%s/results/fluctuations_trunc.txt',working_directory_path));

wavenr = load(sprintf('%s/results/wavenumbers_trunc.txt',working_directory_path));
...
figure(4)
semilogy(wavenr,fluct,'o-')%,wavenr,sigma2u');

figure(6)
semilogy(wavenr,flucta,'o-')%,wavenr,sigma2u');
